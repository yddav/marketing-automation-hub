...
class MarketingAutomationHub {
  ...
  /**
   * Set up payment system routes
   */
  setupPaymentRoutes() {
    // Mount payment routes
    this.app.use('/payment', this.paymentRoutes.getRouter());
    
    // Legacy webhook route (for backwards compatibility)
    this.app.use('/', this.paymentRoutes.getRouter());
    
    this.logger.info('Payment system routes configured');
  }
